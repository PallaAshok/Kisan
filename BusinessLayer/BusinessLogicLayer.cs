...
public class BusinessLogicLayer
{
    ...
    public static DataSet GET_USER_RELATED_DATA(int LoginUserID)
    {
        try
        {
            const string storedprocedure = "[ADMIN].[USERS_GET]";
            var parameters = new SqlParameter[1];
            parameters[0] = new SqlParameter("@USERID", LoginUserID);
            var ds = SQLHelper.GetInstance().ExecuteStoredProcedureReturnDataSet(storedprocedure, parameters);
            return ds;
        }
        catch (Exception Ex)
    ...
    public static DataSet MANAGER_DROPDOEN_GET(int LoginUserID)
    {
        try
        {
            const string storedprocedure = "ADMIN.[MANAGER_DROPDOEN_GET]";
            var parameters = new SqlParameter[1];
            parameters[0] = new SqlParameter("@USERID", SqlDbType.Int) { Value = LoginUserID };
            var ds = SQLHelper.GetInstance().ExecuteStoredProcedureReturnDataSet(storedprocedure, parameters);
            return ds;
        }
        catch (Exception Ex)
    ...
    public static DataSet LOAN_ACCOUNT_DETAILS_INSERT_UPDATE(int LoginUserID, string LoanAccountID, string LoanAccountDetails, string PurposeOfLoan, string Description, string Active)
    {
        try
        {
            ...
            parameters[5] = new SqlParameter("@UserID", SqlDbType.Int) { Value = LoginUserID};
            var ds = SQLHelper.GetInstance().ExecuteStoredProcedureReturnDataSet(storedprocedure, parameters);
            return ds;
        }
        catch (Exception Ex)
    ...
    #region TARGET_GET
    public static DataSet TARGET_GET(int LoginUserID)
    {
        try
        {
            const string storedprocedure = "[RECOVERY].[TARGET_GET]";
            var parameters = new SqlParameter[1];
            parameters[0] = new SqlParameter("@USERID", SqlDbType.Int) { Value = Convert.ToInt32(LoginUserID) };
            var ds = SQLHelper.GetInstance().ExecuteStoredProcedureReturnDataSet(storedprocedure, parameters);
            return ds;
        }
        catch (Exception Ex)
    ...
    public static DataSet GET_BANK_VISIT_RELATED_DATA(int LoginUserID,int? EXID, int? BankID, string FDATE, string TDATE)
    {
        try
        {
    ...
    public static DataSet EXECUTIVE_DROPDOEN_GET(int LoginUserID)
    {
        try
        {
    ...
    public static DataSet BANK_DROPDOWN_GET(int LoginUserID)
    {
        try
        {
            var parameters = new SqlParameter[1];
    ...
    public static DataSet BRANCH_DROPDOWN_GET(int LoginUserID,string BANK)
    {
        try
        {
            var parameters = new SqlParameter[2];
            parameters[0] = new SqlParameter("@BANK", SqlDbType.VarChar) { Value = BANK == "-1" ? null : BANK };
            parameters[1] = new SqlParameter("@USERID", SqlDbType.Int) { Value = LoginUserID };
    ...
    public static DataSet BANK_VISIT_INSERT_UPDATE(int LoginUserID,string BankVisitID, string ExecutiveName, string BankName, string PurposeOfVisit, string Active, string DATET)
    {
        try
        {
            ...
            parameters[4] = new SqlParameter("@USERID", SqlDbType.Int) { Value = Convert.ToInt32(LoginUserID) };
            parameters[5] = new SqlParameter("@ACTIVE", SqlDbType.Bit) { Value = Active };
    ...
    public static DataSet BANK_DROPDOWN_FOR_REPORT(int LoginUserID)
    {
        try
        {
            var parameters = new SqlParameter[1];
    ...
    public static DataSet NPADETAILS_GET1(int LoginUserID,int? ID, int? EXID, string Bank, string Branch, int? CityID, string FDATE, string TDATE)
    {
        try
        {
            ...
            var parameters = new SqlParameter[8];
            parameters[0] = new SqlParameter("@ID", SqlDbType.Int) { Value = ID };
            parameters[1] = new SqlParameter("@USERID", SqlDbType.Int) { Value = Convert.ToInt32(LoginUserID) };
            parameters[2] = new SqlParameter("@EXECUTIVE_ID", SqlDbType.Int) { Value = EXID == -1 ? null : EXID };
            parameters[3] = new SqlParameter("@BANK", SqlDbType.VarChar) { Value = Bank == "-1" ? null : Bank };
            parameters[4] = new SqlParameter("@BRANCH", SqlDbType.VarChar) { Value = Branch == "-1" ? null : Branch };
            parameters[5] = new SqlParameter("@CITY_ID", SqlDbType.Int) { Value = CityID == -1 ? null : CityID };
    ...
    public static DataSet EXECUTIVEWISEVISITDETAILS_GET(int LoginUserID,int? ID, int? EXID, string BANK, string BRANCH, string FDATE, string TDATE, int? CITYID)
    {
        try
        {
    ...
    public static void EXECUTEWISEDETAILS_INSERT_UPDATE(int LoginUserID, string EWVID, string ExecutiveName, string NPADetails, string Date, string LoanAmount, string AmountRecovered, string BalanceAmount, string Comments, string NextDateForVisit, string Active, string BankRangetype)// string PlaceVisited,
    {
        try
        {
            ...
            parameters[8] = NextDateForVisit == "-1" ? new SqlParameter("@NextDateForVisit", DBNull.Value) : new SqlParameter("@NextDateForVisit", SqlDbType.Date) { Value = NextDateForVisit };
            parameters[9] = new SqlParameter("@UserID", SqlDbType.Int) { Value = LoginUserID };
    ...
    public static DataSet RECOVERYBILLDETAILS_GET(int LoginUserID, int? EXECUTIVE, string BANK, string BRANCH, int? NPAID, string FDATE, string TDATE)
    {
        try
        {
    ...
    public static void RECOVERYBILLDETAILS_INSERT_UPDATE(int LoginUserID, string RecoveryBillID, string ExecutiveName, string NPADetails, string RecoveredAmount, string BalanceAmount, string RecoveredDate, string RecoveredAmountCommission, string ServiceTax, string TotalCommission, string BoardCharges, string TransportCharges, string ValuationCharges, string Surveyorcharges, string PropertyIdentificationcharges, string InvestigationCharges, string MiscellaneousCharges, string Active, string BankRangeType)
    {
        try
        {
    ...
    public static DataSet NPADETAILS_FOR_SN(int LoginUserID,int? BANKID)
    {
        try
        {
    ...
    public static DataSet RECOVERY_STATEMENT_GET(int LoginUserID, int? ID, string BANK, string BRANCH, int? NPAID, int? STATUS, string FDATE, string TDATE)
    {
        try
        {
    ...
    public static void RECOVERY_STATEMENT_INSERT_UPDATE(int LoginUserID,string RecoveryStatementID, string BankName, string NPADetails, string BillAmountRecovered, string Date, string Amountlesspaid, string TDS, string Active)
    {
        try
        {
            ...
            parameters[5] = new SqlParameter("@CREATED_BY", SqlDbType.Int) { Value = LoginUserID };
    ...
    public static DataTable USER_DETAILS_REPORT(int LoginUserID)
    {
        try
        {
            var Parameters = new SqlParameter[1];
    ...
    public static DataTable BANK_DETAILS_REPORT(int LoginUserID)
    {
        try
        {
            var parameters = new SqlParameter[1];
    ...
    public static DataTable RECOVERY_BILL_DETAILS(int LoginUserID, int? EXECUTIVE, string BANK, string BRANCH, int? NPAID, string FDATE, string TDATE)
    {
        try
        {
            var Parameters = new SqlParameter[7];
    ...
    public static DataTable BANK_VISIT_DETAILS(int LoginUserID,int? EXID, int? BankID, string FDATE, string TDATE)
    {
        try
        {
            var Parameters = new SqlParameter[5];
    ...
    public static DataTable NPA_DETAILS_REPORT(int LoginUserID,int? EXID, string Bank, string Branch, int? CityID, string FDATE, string TDATE)
    {
        try
        {
            var Parameters = new SqlParameter[7];
    ...
    #region TARGET_GET
    public static DataTable TARGET_GET_REPORT(int LoginUserID)
    {
        try
        {
    ...
    public static int GetUserIDFromCookie()
    {
        ...
        int UserID = 1;// Convert.ToInt32(HttpContext.Current.Request.Cookies[builder.InitialCatalog + "_" + "userid"].Value);
        return UserID;
    }
    #endregion
    ...
    public static MemoryStream GENERATEREPORT(DataTable ExportTable, string ReportName, int ReportType)
    {
        try
        {
                ...
                else if (ReportType == 3)
                {
                    try
                    {
                        ...
                        using (MemoryStream memoryStream = new MemoryStream())
                        {
                            ...
                            //Company Logo
                            Image image = Image.GetInstance(HttpContext.Current.Server.MapPath("~/APPRequires/CR.png"));
    ...
    public static MemoryStream NPA_DETAILS_RECOVERY_REPORT(string ID)
    {
        try
        {
            int FontSize = 11;
    ...
    public static MemoryStream RECOVERY_BILL_PAYMENT_LETTER(DataTable BillDt, string STN, string PAN)
    {
        try
        {
            int FontSize = 11;
