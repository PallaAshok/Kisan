...
using ATeam.Web.Common;
using ATeam.Common.CustomException;
...
public class SQLHelper
{
    ...
    private SQLHelper(string connectionString)
    {
        ...
        try
        {
            _debugEnabled = bool.Parse("false");
        }
        catch (Exception)
        {
            // ignored
    ...
    {
        return _instance ?? (_instance = new SQLHelper("ConnectionString"));
    }
    ...
    private SqlConnection OpenDbConnection()
    {
        ...
        try
        {
            ...
            conn = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings[_connectionString].ConnectionString);
            conn.Open();
        }
